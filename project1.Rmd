...
However, looks like the classe='D' was not able to be classified by this algirithm and the accuracy is too low < 50%.
...
Obviously, the error rate has significant reduced when the number of trees has grown > 50.
